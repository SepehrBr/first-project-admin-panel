@component('admin.layouts.content', [ 'title' => 'Unapproved Comments'])

@slot('breadcrumb')
<li class="breadcrumb-item active">Unapproved Comments List</li>
<li class="breadcrumb-item"><a href="/admin">Admin Dashborad</a></li>
@endslot
    <h2>Unapproved Comments List</h2>
    <div class="row">
        <div class="col-12">
          <div class="card">
            <div class="card-header">
              <h3 class="card-title">Unapproved Comments Table</h3>
                    ...
                    <tr>
                        ...
                        <td>
                            {{-- @can('delete-comment') --}}
                                ...
                                {{-- @endcan
                                @can('approved-comment') --}}
                                <form action="{{route('admin.comments.update',  [ 'comment' => $comment->id  ])}}" method="POST">
                                    @csrf
                                    @method('PATCH')
                                    <button type="submit" class="btn btn-success mt-2">Approved</button>
                                </form>
                            {{-- @endcan --}}
                        </td>
                    </tr>
