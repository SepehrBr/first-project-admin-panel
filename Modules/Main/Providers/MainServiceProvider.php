...
class MainServiceProvider extends ServiceProvider
{
     ...
     */
    protected $moduleNameLower = 'main';
    ...
    public function boot()
    {
        ...
        Module::macro('isEnable', function ($moduleName) {
            return in_array($moduleName, array_keys(Module::getByStatus(1)));
        });
        Module::macro('canDisable', function ($moduleName) {
